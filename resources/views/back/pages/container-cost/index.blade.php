...
@section('content')
    ...
    <x-back.datatable id="containerTable" :ajax="route('admin.container-cost.index')" :header="['No', 'Nomor Container/Seal', 'Pelabuhan Asal', 'Pelabuhan Tujuan', 'ETD', 'Jumlah Invoice', 'Aksi']" :data="[
