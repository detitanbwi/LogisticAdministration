<table>
    <tr>
        <th colspan="15" align="center"><b>CONTAINER COST_LAPORAN PEMBAYARAN</b></th>
    </tr>
    <tr>
        <td colspan="15"></td>
    </tr>
    ...
    <tr>
        ...
        <th style="font-weight: bold; background-color: #fce4d6;">DPP</th>
        <th style="font-weight: bold; background-color: #fce4d6;">Total Tagihan</th>
        <th style="font-weight: bold; background-color: #fce4d6;">Status Tagihan</th>
    ...
    @forelse ($container->invoices as $inv)
        ...
        <tr>
            ...
            <td rowspan="{{ $rowCount }}">{{ number_format($inv->dpp ?? 0, 0, ',', '.') }}</td>
            <td rowspan="{{ $rowCount }}">{{ number_format($inv->grand_total ?? 0, 0, ',', '.') }}</td>
            <td rowspan="{{ $rowCount }}">
                {{ $inv->finance && $inv->finance->status_tagihan == 'lunas' ? 'LUNAS' : 'BELUM LUNAS' }}</td>
