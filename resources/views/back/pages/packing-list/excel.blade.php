<table>
    ...
    <tr>
        <td></td>{{-- Col A spacer --}}
        <th colspan="17" align="center" style="font-weight: bold;"><b>MANIFEST CONTAINER_PACKING LIST</b></th>
    </tr>
    ...
    <tr>
        ...
        <td colspan="9">: {{ $container->asal->nama_tujuan ?? '-' }}</td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="9">: {{ $container->tipe_kontainer ?? '-' }}</td>
    </tr>
    ...
    @empty
        <tr>
            <td></td>
            <td colspan="17" style="border: 1px solid #000;">Belum ada invoice di dalam container ini.</td>
        </tr>
    @endforelse
