...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::table('container', function (Blueprint $table) {
            $table->foreignId('kapal_id')->nullable()->constrained('kapal')->nullOnDelete();
            $table->foreignId('asal_id')->nullable()->constrained('tujuan')->nullOnDelete();
    ...
    public function down(): void
    {
        Schema::table('container', function (Blueprint $table) {
            ...
            $table->dropColumn(['kapal_id', 'asal_id', 'tujuan_id', 'etd', 'eta', 'metode', 'tipe_kontainer', 'catatan']);
        });
    }
};
